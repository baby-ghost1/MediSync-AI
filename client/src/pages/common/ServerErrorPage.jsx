      ...
      >
        <div className="relative overflow-hidden rounded-[34px] bg-[var(--card)] p-8 text-center sm:p-12">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-amber-200/60 bg-amber-50/80 px-4 py-1.5 text-xs font-medium text-amber-700 shadow-sm dark:border-amber-800/30 dark:bg-amber-900/15 dark:text-amber-400"
          >
          ...
          <div className="relative mt-10 flex items-center justify-center">
            ...
            <motion.h1
              ...
              className="relative bg-gradient-to-r from-amber-600 via-orange-500 to-yellow-500 bg-clip-text text-[100px] font-black leading-none tracking-tighter text-transparent sm:text-[120px] lg:text-[200px]"
            >
              500
            </motion.h1>
          </div>
          ...
          >
            <MotionLink
              ...
              whileTap={{ scale: 0.96 }}
              className="group relative inline-flex h-12 items-center gap-2.5 overflow-hidden rounded-xl bg-gradient-to-r from-amber-600 via-orange-500 to-yellow-500 px-8 text-base font-semibold text-white shadow-lg transition-shadow duration-300 hover:shadow-[0_8px_30px_rgba(217,119,6,0.35)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400"
            >
          ...
          >
            {[
              { icon: ServerCrash, value: "500", label: "Internal Error", color: "text-amber-600 dark:text-amber-400" },
              { icon: RefreshCw, value: "Auto", label: "Retry System", color: "text-orange-600 dark:text-orange-400" },
              { icon: Home, value: "Contact", label: "Support Team", color: "text-yellow-600 dark:text-yellow-400" },
            ].map((item) => (
              <motion.div
                key={item.label}
                whileHover={{ y: -4 }}
