      ...
      >
        <div className="relative overflow-hidden rounded-[34px] bg-[var(--card)] p-8 text-center sm:p-12">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[var(--danger)]/20 bg-[var(--danger-light)] px-4 py-1.5 text-xs font-medium text-[var(--danger)] shadow-sm"
          >
            <span className="relative inline-flex h-1.5 w-1.5">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[var(--danger)]/60" />
          ...
          <div className="relative mt-10 flex items-center justify-center">
            ...
            <motion.h1
              ...
              className="relative bg-[var(--danger)] bg-clip-text text-[100px] font-black leading-none tracking-tighter text-transparent sm:text-[120px] lg:text-[200px]"
            >
              403
            </motion.h1>
          </div>
          ...
          >
            <MotionLink
              ...
              whileTap={{ scale: 0.96 }}
              className="group relative inline-flex h-12 items-center gap-2.5 overflow-hidden rounded-xl bg-[var(--danger)] px-8 text-base font-semibold text-[var(--danger-foreground)] shadow-lg transition-shadow duration-300 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)]"
            >
          ...
          >
            {[
              { icon: Lock, value: "Restricted", label: "Admin Only", color: "text-[var(--danger)]" },
              { icon: ShieldOff, value: "No Access", label: "Limited Role", color: "text-[var(--warning)]" },
